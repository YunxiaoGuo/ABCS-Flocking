...
def get_args():
    parser = argparse.ArgumentParser("Fixed wing UAV Leader-Follower Flocking with ABCS Flocking")
    # Environment
    parser.add_argument("--max-episode-len", type=int, default=100, help="maximum episode length")
    parser.add_argument("--time-steps", type=int, default=2000000, help="number of time steps")
    parser.add_argument("--n-agents", type=int, default=2, help="number of flocking agents")
